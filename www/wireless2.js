...
function automode_hint() {
    var gmode = document.form.wl_gmode_1.value;
    if ((gmode == "2" || gmode == "3" || gmode == "4") &&
       (document.form.wl_wep_x_1.value == 1 || document.form.wl_wep_x_1.value == 2 || document.form.wl_auth_mode_1.value == "radius" ||
            (document.form.wl_crypto_1.value.indexOf("tkip") == 0 && !document.form.wl_crypto_1.disabled)))
        $("wl_gmode_hint_1").style.display = "block";
    else
        $("wl_gmode_hint_1").style.display = "none";
}

function nmode_limitation() {
    var gmode = document.form.wl_gmode_1.value;
    if (gmode == "1" || gmode == "3") {
        if (document.form.wl_auth_mode_1.selectedIndex == 0 && (document.form.wl_wep_x_1.selectedIndex == "1" || document.form.wl_wep_x_1.selectedIndex == "2")) {
            alert("<#WLANConfig11n_nmode_limition_hint#>");
            document.form.wl_auth_mode_1.selectedIndex = 0;
            document.form.wl_wep_x_1.selectedIndex = 0;
        }
        else if (document.form.wl_auth_mode_1.selectedIndex == 1) {
            alert("<#WLANConfig11n_nmode_limition_hint#>");
            document.form.wl_auth_mode_1.selectedIndex = 3;
            document.form.wl_wpa_mode_1.value = 2;
        }
        else if (document.form.wl_auth_mode_1.selectedIndex == 2) {
            alert("<#WLANConfig11n_nmode_limition_hint#>");
            document.form.wl_auth_mode_1.selectedIndex = 3;
            document.form.wl_wpa_mode_1.value = 2;
        }
        else if (document.form.wl_auth_mode_1.selectedIndex == 5) {
            alert("<#WLANConfig11n_nmode_limition_hint#>");
            document.form.wl_auth_mode_1.selectedIndex = 6;
        }
        else if (document.form.wl_auth_mode_1.selectedIndex == 7 && (document.form.wl_crypto_1.selectedIndex == 0 || document.form.wl_crypto_1.selectedIndex == 2)) {
            alert("<#WLANConfig11n_nmode_limition_hint#>");
            document.form.wl_crypto_1.selectedIndex = 1;
        }
...
function change_common_wl(o, s, v) {
    ...
    if (v == "wl_auth_mode_1") {
        ...
        if (o.value == "psk" || o.value == "wpa") {
            opts = document.form.wl_auth_mode_1.options;

            if (opts[opts.selectedIndex].text == "WPA-Personal") {
                document.form.wl_wpa_mode_1.value = "1";
                automode_hint();
            }
            else if (opts[opts.selectedIndex].text == "WPA2-Personal")
                document.form.wl_wpa_mode_1.value = "2";
            else if (opts[opts.selectedIndex].text == "WPA-Auto-Personal")
                document.form.wl_wpa_mode_1.value = "0";
            else if (opts[opts.selectedIndex].text == "WPA-Enterprise")
                document.form.wl_wpa_mode_1.value = "3";
            else if (opts[opts.selectedIndex].text == "WPA-Auto-Enterprise")
                document.form.wl_wpa_mode_1.value = "4";

            if (o.value == "psk") {
                document.form.wl_wpa_psk_1.focus();
                document.form.wl_wpa_psk_1.select();
            }
        }
        else if (o.value == "shared") {
            document.form.wl_key1_1.focus();
            document.form.wl_key1_1.select();
        }
        nmode_limitation();
        automode_hint();
    }
    else if (v == "wl_crypto_1") {
        wl_auth_mode_change(0);
        nmode_limitation();
        automode_hint();
    }
    else if (v == "wl_wep_x_1") {
        change_wlweptype(o, "WLANConfig11a");
        nmode_limitation();
        automode_hint();
    }
    else if (v == "wl_key_1") {
        var selected_key = eval("document.form.wl_key_1" + 1/*o.value*/);

        selected_key.focus();
        selected_key.select();
    }
    else if (v == "wl_country_code_1") {
        insertChannelOption();
        insertExtChannelOption();
    }
    else if (v == "wl_channel_1") {
        insertExtChannelOption();
    }
    else if (v == "wl_HT_BW_1") {
        insertExtChannelOption();
    }
    else if (v == "wl_gmode_1") {
        enableExtChRows(o);
        insertExtChannelOption();
        nmode_limitation();
        automode_hint();
...
function change_wlweptype(o, s, isload) {
    ...
    if (o.value == "0") {
        ...
        document.form.wl_key1_1.value = wep;
        //        document.form.wl_key2_1.value = wep;
        //        document.form.wl_key3_1.value = wep;
        //        document.form.wl_key4_1.value = wep;
    }
    else {
        wflag = 1;

        //        if (document.form.wl_phrase_x_1.value.length > 0 && isload == 0)
        //            is_wlphrase("WLANConfig11a", "wl_phrase_x_1", document.form.wl_phrase_x_1);
    }

//    inputCtrl(document.form.wl_phrase_x, wflag);
    inputCtrl(document.form.wl_key1_1, wflag);
...
function change_wlkey(o, s) {
    ...
    if (document.form.current_page.value == "Advanced_WirelessGuest_Content.asp")
        ...
        wep = document.form.wl_wep_x_1.value;
...
function changeWEPType() {
    var wflag;
    if (document.form.wl_wep_1.value == "0") {
        wflag = 0;
    }
    else {
        wflag = 1;
...
function changeAuthType() {
    if (document.form.wl_auth_mode_1.value == "shared") {
        inputCtrl(document.form.wl_crypto_1, 0);
        inputCtrl(document.form.wl_wpa_psk_1, 0);
        inputCtrl(document.form.wl_wep_1, 1);
...
//        inputCtrl(document.form.wl_wpa_gtk_rekey, 0);
    ...
    else if (document.form.wl_auth_mode_1.value == "psk") {
...
//        inputCtrl(document.form.wl_wpa_gtk_rekey, 0);
    ...
    else if (document.form.wl_auth_mode_1.value == "wpa") {
        inputCtrl(document.form.wl_crypto_1, 0);
        inputCtrl(document.form.wl_wpa_psk_1, 0);
        inputCtrl(document.form.wl_wep_1, 0);
//        inputCtrl(document.form.wl_phrase_x, 0);
        inputCtrl(document.form.wl_key1_1, 0);
...
//        inputCtrl(document.form.wl_wpa_gtk_rekey, 0);
    ...
    else if (document.form.wl_auth_mode_1.value == "radius") {
        inputCtrl(document.form.wl_crypto_1, 1);
        inputCtrl(document.form.wl_wpa_psk_1, 1);
        inputCtrl(document.form.wl_wep_1, 1);
      //  inputCtrl(document.form.wl_phrase_x, 1);
...
//        wepKey4 = document.form.wl_guest_key4_1;
        ...
        wepType = document.form.wl_wep_x_1.value;
        wepKey1 = document.form.wl_key1_1;
...
function wl_wep_change() {
    var mode = document.form.wl_auth_mode_1.value;
    var wep = document.form.wl_wep_x_1.value;
...
//        inputCtrl(document.form.wl_wpa_gtk_rekey, 1);
        inputCtrl(document.form.wl_wep_x_1, 0);
//        inputCtrl(document.form.wl_phrase_x, 0);
        inputCtrl(document.form.wl_key1_1, 0);
//        inputCtrl(document.form.wl_key2, 0);
//        inputCtrl(document.form.wl_key3, 0);
...
function change_wep_type(mode, isload) {
    var cur_wep = document.form.wl_wep_x_1.value;
    var wep_type_array;
    var value_array;

    free_options(document.form.wl_wep_x_1);
    ...
    add_options_x2(document.form.wl_wep_x_1, wep_type_array, value_array, cur_wep);

    if (mode == "psk" || mode == "wpa" || mode == "wpa2" || mode == "radius")
        document.form.wl_wep_x_1.value = "0";

    change_wlweptype(document.form.wl_wep_x_1, "WLANConfig11a", isload);
}
...
function insertChannelOption() {
    var channels;
    var country = document.form.wl_country_code_1.value;
    var orig = document.form.wl_channel_1.value;
    free_options(document.form.wl_channel_1);
    ...
    if (country == "AL" ||
        ...
        channels = new Array(0,  36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 149, 153, 157, 161, 165); 
    else if (country == "JP")
    ...
    add_options_x2(document.form.wl_channel_1, channels, ch_v, orig);
}
...
function insert_vht_bw(ins){
    var o = document.form.wl_HT_BW_1;
    var v = o.value;
...
function wl_auth_mode_change(isload) {
    ...
    if (mode == "psk") {
        ...
        for (var i = 0; i < document.form.wl_crypto_1.length; i++) {
            if (document.form.wl_crypto_1[i].selected) {
                cur = document.form.wl_crypto_1[i].value;
                break;
            }
        }
        ...
        document.form.wl_crypto_1.length = algos.length;
        for (var i in algos) {
            document.form.wl_crypto_1[i] = new Option(algos[i], algos[i].toLowerCase());
            document.form.wl_crypto_1[i].value = algos[i].toLowerCase();

            if (algos[i].toLowerCase() == cur)
                document.form.wl_crypto_1[i].selected = true;
        }
    }
    else if (mode == "wpa") {
        for (var i = 0; i < document.form.wl_crypto_1.length; i++) {
...
//    for (var i = 0; i < 1/*document.form.wl_key.length*/; i++) {
...
function validate_wlkey(key_obj){
	...
	if(wep_type == "0")
		...
		if(key_obj.value.length == 5 && validate_string(key_obj)){
		    document.form.wl_key_type_1.value = 1;
			iscurrect = true;
		}
		else if(key_obj.value.length == 10 && validate_hex(key_obj)){
		    document.form.wl_key_type_1.value = 0;
			iscurrect = true;
		}
		else{
