...
function clickEvent(obj){
	...
	else if(obj.id.indexOf("System") > 0){
		icon = "big-icons-router-active";
		ContainerWidth = "300px";
		Containerpadding = "5px";
		
	    stitle = "<#statusTitle_SStatus#>";
                        ...
                        <div class="well" style="height: 570px; padding-left: 18px;">
                            ...
                            <table class="table table-big" style="margin-top: 12px;">
                                <tbody>
                                    ...
                                    <tr id="row_system">
                                        <td width="30%">
                                            <a id="linkSystem" href="/device-map/system.asp" target="statusframe" style="outline:0;">
                                                <div id="iconSystem" class="big-icons big-icons-router" onclick="clickEvent(this);"></div>
                                            </a>
                                            <div id="systemStatus" style="position:absolute; visibility:hidden; z-index:1000;"></div>
                                            <div style="position: absolute; margin-top: -47px; margin-left: 50px;"><div id="sysStatus" style="padding-left: 3px;"></div></div>
                                            <div class="arrow-right" id="Div1"><img src="/bootstrap/img/arrow-right.png"></div>
                                        </td>
                                    </tr>
<!--                                    <tr id="row_radio">
                                        <td width="30%">
