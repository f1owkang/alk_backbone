...
function show_battery(charge_mode,bat_value){
	var level = "0";
...
function setSystemInfo(response){
	...
	show_battery(sysinfo.bat_charge, sysinfo.bat_value);
}
...
//	bc += '  </tr>\n';
    ...
    bc +=  '  <tr>\n';
    bc += '    <td><#General_x_FirmwareVersion_itemname#></td>\n';
    bc += '    <td colspan="2"><a href="/Advanced_FirmwareUpgrade_Content.asp"><span id="firmver" class="time"></span></a></td>\n';
    bc += '  </tr>\n';	
...
tabtitle[5] = new Array("", "<#menu5_6_12#>", "<#menu5_6_14#>","<#IMEI_MODIFY#>");
tabtitle[6] = new Array("", "<#menu5_6_2#>", /*"<#menu5_6_5#>",*/"<#menu5_6_3#>", "<#menu5_6_4#>", /*"<#menu5_6_11#>","<#menu5_6_12#>",*/"<#menu5_6_13#>");
//tabtitle[7] = new Array("", "<#menu5_10_1#>", "<#menu5_10_2#>", "<#menu5_10_3#>");
tabtitle[7] = new Array("", "<#menu5_11#>", "<#menu5_12#>", "WAN", "", "", "", "", "", "", "");
tabtitle[8] = new Array("", "<#menu5_7_2#>"/*, "<#menu5_7_3#>", "<#menu5_7_5#>", "<#menu5_7_6#>", "<#menu5_7_8#>"*/);
tabtitle[9] = new Array("", "<#menu5_7_2#>"/*, "<#menu5_7_3#>", "<#menu5_7_5#>", "<#menu5_7_6#>", "<#menu5_7_8#>"*/);
tabtitle[10] = new Array("", "<#menu5_11_1#>", "<#menu5_11_2#>", "<#menu5_11_4#>", "<#menu5_11_3#>", "<#menu5_11_5#>");
...
tablink[4] = new Array("", "Advanced_BasicFirewall_Content.asp", /*"Advanced_Netfilter_Content.asp", "Advanced_URLFilter_Content.asp", */"Advanced_MACFilter_Content.asp", /*"Advanced_Firewall_Content.asp",*/"Advanced_VirtualServer_Content.asp","Advanced_Exposed_Content.asp","Advanced_IPFiltering.asp","Advanced_PortFiltering.asp");//??�??//tablink[5] = new Array("", "Advanced_AiDisk_others.asp", "Advanced_AiDisk_samba.asp", "Advanced_AiDisk_ftp.asp", "Advanced_Modem_others.asp", "Advanced_Printer_others.asp");
tablink[5] = new Array("", "Advanced_Settings_Content.asp","Advanced_Settings_Band.asp","Advanced_MIMEI_Content.asp");
tablink[6] = new Array("", "Advanced_System_Content.asp", /*"statistic.asp",*/ "Advanced_FirmwareUpgrade_Content.asp", "Advanced_SettingBackup_Content.asp", /*"Advanced_NMS_Content.asp", "Advanced_Settings_Content.asp",*/"Advanced_System_AutoSleep.asp");
//tablink[7] = new Array("", "Advanced_Tweaks_Content.asp", "Advanced_Scripts_Content.asp", "Advanced_InetDetect_Content.asp");
tablink[7] = new Array("", "Main_WStatus2g_Content.asp", "Main_WStatus_Content.asp", "", "", "", "", "", "", "", "");
tablink[8] = new Array("", "Main_LogStatus_Content.asp"/*, "Main_DHCPStatus_Content.asp", "Main_IPTStatus_Content.asp", "Main_RouteStatus_Content.asp", "Main_CTStatus_Content.asp"*/);
...
tablink[10] = new Array("", "smsInbox.asp","smsOutbox.asp","smsNotSendbox.asp","smsSend.asp","Advanced_SMS_Forward.asp");
if (found_app_scutclient()){
...
menuL2_title = new Array("", "<#menu5_11#>", "<#menu5_12#>", "<#menu5_2#>", "<#menu5_3#>", "<#menu5_5#>", "<#menu5_4#>", "<#menu5_6#>", /*"<#menu5_9#>", */"<#menu5_7#>");
if (found_app_scutclient()){
...
menuL2_link  = new Array("", tablink[0][1], tablink[1][1], tablink[2][1], tablink[3][1], tablink[4][1], tablink[5][1], tablink[6][1], /*tablink[7][1], */"Main_LogStatus_Content.asp"/*support_2g_radio() ? tablink[8][1] : "Main_EStatus_Content.asp"*/);
...
menuL1_title = new Array("", "<#menu1#>", /*"<#menu3#>", "<#menu2#>", "<#menu6#>",*/ "<#menu4#>", /*"<#menu7#>", */"<#menu11#>","<#menu5#>","<#menu5_8#>");
menuL1_link = new Array("", "index.asp", /*"aidisk.asp", "vpnsrv.asp", "vpncli.asp",*/ "Main_TrafficMonitor_realtime.asp", /*"SpeedTest.asp", */"smsInbox.asp","as.asp","Advanced_System_Info.asp");
menuL1_icon = new Array("", "icon-home", /*"icon-hdd", "icon-retweet", "icon-globe", "icon-tasks", "icon-random", */"icon-tasks","icon-envelope","icon-wrench","icon-wrench");
