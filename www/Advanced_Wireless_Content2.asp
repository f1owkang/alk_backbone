...
function validForm(){
    ...
    if(document.form.wl_radio_x_1[0].checked){
                                        ...
                                        <tr>
                                            ...
                                            <td style="border-top: 0 none;">
                                                <div class="main_itoggle">
                                                    <div id="wl_radio_x_1_on_of">
                                                        <input type="checkbox" id="wl_radio_x_1_fake" <% nvram_match_x("","wl_radio_x_1", "1", "value=1 checked"); %><% nvram_match_x("","wl_radio_x_1", "0", "value=0"); %>>
                                                    </div>
                                                </div>
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" name="wl_radio_x_1" id="wl_radio_x_1_1" value="1" <% nvram_match_x("","wl_radio_x_1", "1", "checked"); %> /><#checkbox_Yes#>
                                                    <input type="radio" name="wl_radio_x_1" id="wl_radio_x_1_0" value="0" <% nvram_match_x("","wl_radio_x_1", "0", "checked"); %> /><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
<!--                                        <tr>
