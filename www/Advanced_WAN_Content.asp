...
//	}
	...
	fixed_change_wan_type(document.form.wan_eth_proto.value);
...
//	if($("tbl_dhcp_sect").style.display != "none" && !document.form.x_DHCPClient[0].checked)
    if($("tbl_dhcp_sect").style.display != "none" && document.form.wan_proto.value == "static")
	{
...
function change_wan_type(wan_type, flag){
	...
	var is_static = (wan_type == "ethernet_mobile" || wan_type == "ethernet") ? 1 : 0;
...
//		
		...
		showhide_div("eth_selection", is_static);
		if(!is_static)
		    fixed_change_wan_type("");
		else
		    fixed_change_wan_type(document.form.wan_eth_proto.value);
...
function fixed_change_wan_type(wan_type){
	...
	if(wan_type == "static"){
	    showhide_div("tbl_dhcp_sect", true);
	    showhide_div("row_wan_ipaddr", true);
	    showhide_div("row_wan_netmask", true);
	...
	{
	    showhide_div("tbl_dhcp_sect", false);
                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <select class="input" name="wan_proto" onchange="change_wan_type(this.value);">
                                                    <option value="ethernet_mobile" <% nvram_match_x("", "wan_proto", "ethernet_mobile", "selected"); %>>WAN: <#BOP_ctype_title5#></option>
                                                    <option value="ethernet" <% nvram_match_x("", "wan_proto", "ethernet", "selected"); %>>WAN: <#BOP_ctype_title1#></option>
                                                    <option value="mobile" <% nvram_match_x("", "wan_proto", "mobile", "selected"); %>><#BOP_mobile_fix#></option>
              
                                                </select>
                                            </td>
                                        </tr>
                                        <tr id="eth_selection">
                                            <th width="50%"><#Layer3ETH_ConnectionType_itemname#></th>
                                            <td align="left">
                                                <select class="input" name="wan_eth_proto" onchange="fixed_change_wan_type(this.value);">
                                                    <option value="dchp" <% nvram_match_x("", "wan_eth_proto", "dhcp", "selected"); %>>DHCP</option>
                                                    <option value="static" <% nvram_match_x("", "wan_eth_proto", "static", "selected"); %>><#BOP_STATIC_IP#></option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="wan_ttl_value" class="input">
                                                    <option value="64" <% nvram_match_x("", "wan_ttl_value", "64", "selected"); %>><#WAN_TTL_Value_Item0#> (*)</option>
                                                    <option value="64" <% nvram_match_x("", "wan_ttl_value", "64", "selected"); %>><#WAN_TTL_Value_Item1#></option>
                                                    <option value="65" <% nvram_match_x("", "wan_ttl_value", "65", "selected"); %>><#WAN_TTL_Value_Item2#></option>
                                                </select>
                                            </td>
                                        </tr>
                                    </table>-->
