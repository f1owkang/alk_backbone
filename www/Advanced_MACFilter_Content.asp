                                        ...
                                        <tr>
                                            <td width="25%">
                                                ...
                                                <div class="input-append">
                                                    <input type="text" maxlength="12" class="span12" size="12" name="macfilter_list_x_0" value="<% nvram_get_x("", "macfilter_list_x_0"); %>" onKeyPress="return is_hwaddr(event);" style="float:left; width: 210px">
