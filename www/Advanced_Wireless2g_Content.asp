...
//			return false;
		...
		var cur_wep_key = eval('document.form.rt_key'+1/*document.form.rt_key.value*/);
                                        ...
                                        <tr id="row_wpa2">
                                            ...
                                            <td>
                                                <div class="input-append">
                                                    <input type="password" name="rt_wpa_psk" id="rt_wpa_psk" maxlength="63" size="32" value="" style="width: 175px;">
