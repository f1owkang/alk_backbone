...
function change_proto(){
	...
	inputCtrl(document.form.vts_sport_x_0, true);
	inputCtrl(document.form.vts_lport_x_0, true);
//	if(v){
...
//	}else{
		...
		document.form.vts_sport_x_0.style.display = "";
...
//				return false;
//		}
		obj = document.form.vts_sport_x_0;
		if(obj.value=="" && !proto_other){
			alert("<#JS_fieldblank#>");
			obj.focus();
			return false;
		}
		obj = document.form.vts_eport_x_0;
		if(obj.value=="" && !proto_other){
			alert("<#JS_fieldblank#>");
			obj.focus();
			return false;
...
//		code +='<td>&nbsp;'             + VSList[i][6] + '</td>';
		code +='<td width="10%">&nbsp;' + sport + '</td>';
		code +='<td width="10%">&nbsp;' + eport + '</td>';
		code +='<td width="75%">&nbsp;' + VSList[i][3] + '</td>';
...
//		code +='<td width="11%">&nbsp;' + proto + '</td>';
		...
		code += '<td width="10%">&nbsp;</td>'
		code += '<td width="75%">&nbsp;</td>'
		code += '<td width="5%" style="text-align: right;"><button class="btn btn-danger" type="submit" onclick="markGroupVS(this, 64,\' Del \');" name="VSList"><i class="icon icon-minus icon-white"></i></button></td>';
		code += '</tr>'
	}
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box well grad_colour_dark_blue">
                            <h2 class="box_head round_top"><#menu5_5#> - <#menu5_3_4#></h2>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table table-list" id="VSList_Block">
                                        ...
                                        <tr>
                                          <!--  <td><#IPConnection_VServerDescript_itemname#></td>-->
                                            ...
                                            <!--<td width="15%" id="col_port_proto"><a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,18,2);"><#IPConnection_VServerPort_itemname#></a></td>-->
                                            <td width="10%"><#Start_Port#></td>
                                            <td width="10%"><#End_Port#></td>
                                            <td width="75%"><#IPConnection_VServerIP_itemname#></td>
                                        ...
                                        <tr>
                                           <td>
                                                <input type="text" size="10" class="span12"  name="vts_sport_x_0" value="<% nvram_get_x("", "vts_sport_x_0"); %>" onkeypress="return is_portrange(this,event);" />
                                            </td>
                                           <td>
                                                <input type="text" size="10" class="span12" name="vts_eport_x_0" value="<% nvram_get_x("", "vts_eport_x_0"); %>" onKeyPress="return is_portrange(this,event);"/>
                                            </td>
<!--                                            <td>
...
<!--                                            <td>
                                            ...
                                            <td>
                                                <button class="btn" type="submit" onclick="return markGroupVS(this, 64, ' Add ');" name="VSList2" value="<#CTL_add#>"><i class="icon icon-plus"></i></button>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 0 none;"><center><input  name="VSList" type="button submit"  type="button" class="btn btn-primary" style="width: 219px" onclick="applyRule();" value="<#CTL_apply#>"/></center></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
